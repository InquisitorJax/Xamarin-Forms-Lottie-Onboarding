...
namespace Core
{
    public class XFormsNavigationService : INavigationService
    {
        ...
        public async Task GoBack()
        {
            if (_isSuspended)
            {
                Debug.WriteLine("Navigation.GoBack while suspended");
                return;
            }
        ...
        public async Task NavigateAsync(string destination, Dictionary<string, string> args = null, bool modal = false, bool forgetCurrentPage = false, bool resetNavigation = false)
        {
            if (_isSuspended)
            {
                Debug.WriteLine("Navigation.Navigate while suspended");
                return;
            }
        ...
        private void Page_Disappearing(object sender, EventArgs e)
        {
            if (_isSuspended)
            {
                Debug.WriteLine("Navigation.Page_Disappearing while suspended - view not popped");
                return;
            }
        ...
        private async Task ResetNavigation(Page newRootPage)
        {
            ...
            {
                var masterDetailPage = newRootPage as MasterDetailPage;
